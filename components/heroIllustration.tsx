// Hero illustration component matching the design from the image
// This creates the decorative graphic on the right side of the landing page
    ...
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <div className="relative w-full max-w-md h-96">
        ...
        >
          {/* Main green blob */}
          <path
            d="M200,50 Q100,80 80,150 Q60,220 100,280 Q140,340 200,350 Q260,340 300,280 Q340,220 320,150 Q300,80 200,50 Z"
            fill="#1a5f3f"
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          <div className="absolute bottom-20 left-20 transform -rotate-12">
            <div className="w-18 h-12 bg-white rounded shadow-lg flex">
              <div className="w-1/2 border-r border-gray-200"></div>
              <div className="w-1/2"></div>
            </div>
          </div>
          ...
          <div className="absolute top-32 left-24 transform rotate-45">
            ...
            <div className="w-3 h-3 bg-yellow-600 rounded-full -mt-1 ml-[-4px]"></div>
          </div>
