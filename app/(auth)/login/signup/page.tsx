        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mt-6">
              ...
              <div className="space-y-2">
                <Link href="/dashboard/posts/new" className="block w-full text-left px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors">
                  Write New Post
                </Link>
                <Link href="/dashboard/posts" className="block w-full text-left px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors">
                  Manage Posts
                </Link>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
              ...
              {postsError && (
                <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded mb-6 flex flex-col gap-2">
                  <div>{postsError}</div>
                  <button
                    onClick={handleRetryFetch}
                    className="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 transition-colors text-sm font-medium self-start"
                  >
                    Try Again
                  </button>
                </div>
                    ...
                    <div key={post._id} className="border border-gray-200 rounded-lg hover:shadow-md transition-shadow p-6">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center gap-2 ml-4 flex-shrink-0">
                          ...
                          <button
                            onClick={() => handlePublishToggle(post._id, post.published)}
